...
const electron_1 = require("electron"); // only valid after app ready, but we call it after ready
let db;
function initDatabase() {
    const dbPath = path_1.default.join(electron_1.app.getPath('userData'), 'parvazlog.db');
